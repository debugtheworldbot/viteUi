<template>
  <div>
    ...
    <div class="demo">
      ...
      <div class="demo-code">
        <pre class="language-html" v-html="Prism.highlight(Switch1Code,Prism.languages.html,'html')" />
      </div>
    </div>
    <div class="demo">
      <h2>支持 disabled </h2>
      ...
      <div class="demo-code">
        <pre class="language-html" v-html="Prism.highlight(Switch2Code,Prism.languages.html,'html')" />
      </div>
    </div>
  </div>
</template>
